...
<!-- board:per-sample -->
Generated by `benchmarks/board.py` from `benchmarks/reference/c-type-nn-7333bf7.jsonl`, `benchmarks/results/board-per-sample.jsonl` (5 seeds, batch 1, cpu).

| task | model | hold MSE | ± sd | hold acc | train MSE | params | ± sd | layers | train s | µs/inf |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| xor | C type-nn | n/a | n/a | n/a | 5.87e-09 | 26.4 | 3.6 | 1→2.0 | 0.01 | 0.1 |
| xor | C type-nn-overfit | n/a | n/a | n/a | 1.39e-07 | 107.6 | 73.4 | 1→3.0 | 0.02 | 0.6 |
...
| iris | C type-nn | 0.0215 | 0.0069 | 0.969 | 8.43e-04 | 125.4 | 52.2 | 3→3.8 | 0.47 | 0.6 |
| iris | C type-nn-overfit | 0.0249 | 0.0044 | 0.960 | 1.81e-03 | 174.6 | 29.8 | 3→4.0 | 0.09 | 0.6 |
...
| wine | C type-nn-overfit | 0.0209 | 0.0105 | 0.967 | 1.61e-04 | 392.6 | 43.7 | 4→5.0 | 0.14 | 1.0 |
...
| wdbc | C type-nn | 0.0448 | 0.0048 | 0.951 | 1.01e-04 | 162.8 | 28.7 | 3→4.0 | 0.21 | 0.4 |
| wdbc | C type-nn-overfit | 0.0459 | 0.0030 | 0.950 | 4.22e-04 | 162.6 | 31.2 | 3→3.2 | 0.07 | 0.3 |
...
| diabetes | C type-nn-overfit | 0.0371 | 0.0015 | n/a | 2.40e-02 | 33.0 | 8.5 | 2→2.2 | 0.04 | 0.2 |
...
| ionosphere | C type-nn | 0.0886 | 0.0111 | 0.904 | 9.70e-03 | 153.8 | 65.0 | 4→4.4 | 0.27 | 0.1 |
| ionosphere | C type-nn-overfit | 0.0813 | 0.0119 | 0.913 | 4.33e-03 | 298.0 | 60.5 | 4→4.4 | 0.11 | 0.8 |
...
| iris | torch ref-type-nn vs C type-nn | +0.0115 | 0.0141 | higher, within noise | 1.15× |
| iris | torch ref-type-nn-overfit vs C type-nn-overfit | +0.0023 | 0.0050 | higher, within noise | 0.91× |
| wine | torch ref-type-nn vs C type-nn | -0.0079 | 0.0076 | lower, **clear** | 1.26× |
| wine | torch ref-type-nn-overfit vs C type-nn-overfit | +0.0155 | 0.0134 | higher, **clear** | 0.91× |
| wdbc | torch ref-type-nn vs C type-nn | -0.0009 | 0.0066 | lower, within noise | 1.08× |
| wdbc | torch ref-type-nn-overfit vs C type-nn-overfit | -0.0023 | 0.0059 | lower, within noise | 1.14× |
...
| ionosphere | torch ref-type-nn vs C type-nn | +0.0033 | 0.0214 | higher, within noise | 1.02× |
| ionosphere | torch ref-type-nn-overfit vs C type-nn-overfit | +0.0087 | 0.0207 | higher, within noise | 1.07× |
<!-- /board:port -->
...
| task | comparison | Δ hold MSE | 2se | verdict | params ratio |
|---|---|---:|---:|---|---:|
| xor | C type-nn vs C c-mlp | n/a | n/a | both fit (no hold-out) | 0.80× |
| xor | C type-nn-overfit vs C c-mlp | n/a | n/a | both fit (no hold-out) | 3.26× |
| iris | C type-nn vs C c-mlp | -0.0065 | 0.0083 | lower, within noise | 1.87× |
| iris | C type-nn-overfit vs C c-mlp | -0.0032 | 0.0067 | lower, within noise | 2.61× |
| wine | C type-nn vs C c-mlp | +0.0043 | 0.0066 | higher, within noise | 0.62× |
| wine | C type-nn-overfit vs C c-mlp | -0.0025 | 0.0107 | lower, within noise | 1.43× |
| wdbc | C type-nn vs C c-mlp | +0.0010 | 0.0046 | higher, within noise | 0.32× |
| wdbc | C type-nn-overfit vs C c-mlp | +0.0021 | 0.0031 | higher, within noise | 0.32× |
| diabetes | C type-nn vs C c-mlp | -0.0158 | 0.0038 | lower, **clear** | 0.11× |
| diabetes | C type-nn-overfit vs C c-mlp | -0.0117 | 0.0040 | lower, **clear** | 0.17× |
| ionosphere | C type-nn vs C c-mlp | -0.0575 | 0.0170 | lower, **clear** | 0.27× |
| ionosphere | C type-nn-overfit vs C c-mlp | -0.0648 | 0.0174 | lower, **clear** | 0.52× |
<!-- /board:c-board -->
